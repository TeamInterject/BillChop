...
export default class GroupTable extends React.Component<IGroupTableProps, IGroupTableState> {
    ...
    renderTableContent() {
        ...
        tableContent.push(
            <tr>
                ...
                <td><Button variant="outline" onClick={this.handleOnClick}>Add</Button></td>
            </tr>
        );
        return tableContent;
    }
